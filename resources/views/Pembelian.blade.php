        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            >
              ...
              <span class="text" onclick="window.location.href='Dashboard';">Dashboard</span>
            </a>
          <li class="nav-item nav-item-has-children">
            <a
              href="#0"
            ...
            >
              ...
              <span class="text" onclick="window.location.href='Stok';">Stok</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="Pembelian">
              ...
              <span class="text" onclick="window.location.href='Pembelian';">Pembelian</span>
            </a>
          </li>
          <li class="nav-item nav-item-has-children">
            <a
            ...
            >
              ...
              <span class="text" onclick="window.location.href='Laporan';">Laporan</span>
            </a>
          </li>
                  ...
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        ...
                        <div>
                          <h6 class="fw-500">Halo Naufal</h6>
                          <p>Admin</p>
                        </div>
                      </div>
                    </div>
...
<body>
    <header>
        <h1>Petshop - Pembelian Produk Hewan</h1>
    </header>

    <div class="container">
        <div class="button-container">
            <button class="btn" id="inputPembelianBtn">Input Pembelian</button>
            <button class="btn" id="cetakPembelianBtn">Cetak Pembelian</button>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Jumlah</th>
                        <th>Total</th>
                        <th>Aksi</th> <!-- Menambahkan kolom aksi untuk tombol -->
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="action-btns">
                            <a href="update.php?id=001"><button class="update-btn">Update</button></a>
                            <a href="delete.php?id=001"><button class="delete-btn">Delete</button></a>
                        </td>
                    </tr>
                    <tr>
                        <td>002</td>
                        <td>Vitamin Anjing</td>
                        <td>Obat</td>
                        <td>Rp 50.000</td>
                        <td>1</td>
                        <td>Rp 50.000</td>
                        <td class="action-btns">
                            <a href="update.php?id=002"><button class="update-btn">Update</button></a>
                            <a href="delete.php?id=002"><button class="delete-btn">Delete</button></a>
                        </td>
                    </tr>
                    <tr>
                        <td>003</td>
                        ...
                        <td>Rp 100.000</td>
                        <td class="action-btns">
                            <a href="update.php?id=003"><button class="update-btn">Update</button></a>
                            <a href="delete.php?id=003"><button class="delete-btn">Delete</button></a>
                        </td>
                    </tr>
                </tbody>
            </table>
          ...
          <div class="row">
            <div class="col-md-6 order-last order-md-first">
              <div class="copyright text-center text-md-start">
                <p class="text-sm">
                  Designed   Muhammad Naufal Whildan Sutoko
                  </a>
                </p>
              </div>
            </div>
